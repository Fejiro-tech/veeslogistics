        ...
        <div className="grid grid-cols-1 md:grid-cols-2">
          <div className="md:border-r border-gray-300 md:pr-6 mb-6 md:mb-0">
            <div className="flex justify-between">
              <p className="text-sm md:text-base text-gray-400 mb-1">Sender:</p>
              <p className="font-medium text-sm md:text-base text-gray-800 mb-3">{shipment.sender.name}</p>
            </div>
            <div className="flex justify-between mb-2">
              <p className="text-sm md:text-base text-gray-400">Origin:</p>
              <p className="font-medium text-sm md:text-base text-gray-800">{shipment.sender.origin}</p>
            </div>
            <div className="flex justify-between">
              <p className="text-sm md:text-base text-gray-400">Parcel Description:</p>
              <p className="font-medium text-sm md:text-base text-gray-800">{shipment.packageDescription}</p>
            </div>
          </div>

          <div className="md:pl-6">
            <div className="flex justify-between">
              <p className="text-sm md:text-base text-gray-400 mb-1">Receiver:</p>
              <p className="text-sm md:text-base font-medium text-gray-800 mb-3">{shipment.receiver.name}</p>
            </div>
            <div className="flex justify-between">
              <p className="ttext-sm md:text-base text-gray-400">Address:</p>
              <p className="font-medium text-sm md:text-base text-gray-800">{shipment.receiver.address}</p>
            </div>
          </div>
        </div>
      </div>

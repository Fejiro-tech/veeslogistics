  ...
  return (
    <div>
        <div className='bg-white rounded-2xl shadow-lg max-w-6xl mx-auto px-4 py-6 '>
            <h2 className='mb-4 text-[#166534] font-bold text-base md:text-lg lg:text-md'>Create Shipment</h2>
            <hr className='border-gray-300'/>
            <form onSubmit={handleSubmit}>

                <div className='grid grid-cols-1 md:grid-cols-2 gap-1 md:gap-4 text-[#166534] text-sm md:text-base lg:text-lg  mt-4'>
                    <div className='flex flex-col gap-2 md:gap-4 '>
                        ...
                        <input 
                            ...
                            className='w-full border border-gray-300 p-1 md:p-2 rounded text-base md:text-base'
                        />
                    </div>
                     ...
                     <div className='flex flex-col gap-2 text-[#166534] text-sm md:text-base lg:text-lg'>
                    ...
                    <div className='flex flex-col gap-2 text-[#166534] text-sm md:text-base lg:text-lg'>
                     ...
                     <div className='flex flex-col gap-2 text-[#166534] text-sm md:text-base lg:text-lg'>
                        ...
                        <select
                                ...
                                className='w-full  mb-4 border p-1 md:p-2 rounded text-sm md:text-base border-gray-300 '
                                >

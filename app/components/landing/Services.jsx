...
const Services = () => {
  ...
  return (
    <section className='max-w-360 mx-auto py-24' id='services'>
      <h2 className='text-[#166534] text-3xl md:text-4xl text-center font-bold mb-10 mt-10'>Our Services</h2>
        ...
        {services.map((service, i) => {
          ...
          return (
            <motion.div
              key={i}
              variants={card}
              className='backdrop-blur-md bg-[#166534] border border-[#166534]/40 rounded-2xl shadow-lg text-white text-lg mb-2 p-10 hover:scale-105 transition-transform duration-300 ease-in-out text-center'
            >
              <div className='flex items-center justify-center text-[#FFD600]  mb-4'>
                <Icon size={34} />
              </div>
